...
class MoviesFragment : BaseMvpFragment<MoviesContract.View, MoviesContract.Presenter>(), MoviesContract.View {
    ...
    private fun onMovieClick(view: View, movie: Movie) {
        ...
        val p4 = Pair.create(view.movieRate as View, activity.getString(R.string.transition_movie_rate))
        val options = ActivityOptionsCompat.makeSceneTransitionAnimation(activity, p1, p2, p3, p4)
