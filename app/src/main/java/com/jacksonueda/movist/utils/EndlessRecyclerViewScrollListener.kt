...
class EndlessRecyclerViewScrollListener : RecyclerView.OnScrollListener {
    ...
    private var mFunc: (Int) -> Unit

    constructor(func: (Int) -> Unit, layoutManager: LinearLayoutManager) {
        this.mFunc = func
        this.mLayoutManager = layoutManager
    }

    constructor(func: (Int) -> Unit, layoutManager: GridLayoutManager) {
        this.mFunc = func
        this.mLayoutManager = layoutManager
        visibleThreshold *= layoutManager.spanCount
    }

    constructor(func: (Int) -> Unit, layoutManager: StaggeredGridLayoutManager) {
        this.mFunc = func
        this.mLayoutManager = layoutManager
        visibleThreshold *= layoutManager.spanCount
    }
